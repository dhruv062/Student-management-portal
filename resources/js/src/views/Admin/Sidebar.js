...
export default ({ closeSidebar }) => {
  ...
  return (
    <aside
      id="logo-sidebar"
      className="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 translate-x-0  "
      aria-label="Sidebar"
    >
      <div className="h-full px-3 pb-4 overflow-y-auto bg-white ">
        <ul className="space-y-2 font-medium">
          <li>
            <NavLink to="./" className="navitem " onClick={closeSidebar}>
              <svg
                className=""
                aria-hidden="true"
          ...
          <li>
            <NavLink to="profile" className="navitem " onClick={closeSidebar}>
              <svg
                className=""
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
          ...
          <li>
            <NavLink to="courses" className="navitem" onClick={closeSidebar}>
              <svg
          ...
          <li>
            <NavLink to="users" className="navitem" onClick={closeSidebar}>
              <svg
                className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
          ...
          <li>
            <NavLink to="analytics" className="navitem" onClick={closeSidebar}>
              <svg
                className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
          ...
          <li>
            <NavLink to="issues" className="navitem" onClick={closeSidebar}>
              <svg
                className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
          ...
          <li>
            <NavLink to="chat" className="navitem" onClick={closeSidebar}>
              <svg
                className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
          ...
          {/* <li>
            <NavLink to="contacts" className="navitem" onClick={closeSidebar}>
              <svg
                className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
